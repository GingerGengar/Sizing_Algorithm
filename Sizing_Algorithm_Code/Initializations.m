...
c_Lmax = 1.5; %the maximum lift coefficient we can get
...
endurance = 700; % seconds of flight. This corresponds to 15 minutes of flight
Motor_Power = 786.9837*.75; %This is the power of the motor (W), has to be in cruise conditions
CellNum = 4;
